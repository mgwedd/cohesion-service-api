...
router
  .route(['/', 'health', '/healthcheck', '/monitoring'])
  .get((req, res) => res.render('index', {
    title: 'The Service Request API',
    message: 'Use the /servicerequest (GET/POST) and /servicerequest/:id (GET/PATCH/DELETE) resource paths to CRUD service requests.'
  }))
